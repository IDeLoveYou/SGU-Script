...
*   SGU-Script只为学习开发，若您对该程序有异议，可至github项目提起issue
...
> 请注意以下每一步操作后都请记得点击右下角的保存并应用，下文将不会再提醒您
...
2.  但是原版OpenWrt可能需要您更改SSH隧道的密码，才可以使用SSH，因此你需要在[系统]-[管理权]中修改，同时你的路由器管理界面密码也会被对应修改
...
1.  全部设置完成后，请将网线把wan口（即蓝色的口，但有些固件的接口是乱的，视具体情况而定）与墙上的网口接通

### Ⅱ.开始享受

1.  维护网络安全，保护个人隐私；妥善运用及保护个人信息，避免因个人信息泄露而让犯罪分子有机可乘；树文明新风，建和谐校园
